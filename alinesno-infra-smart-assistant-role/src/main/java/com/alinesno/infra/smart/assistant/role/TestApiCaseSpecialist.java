...
@Slf4j
@Component
public class TestApiCaseSpecialist extends PlatformExpert {

    private static final String promptId = "Qoh7hgA3" ;
    private List<String> resultMap ;

    @LiteflowComponent(value = "TAC_STEP_01", name="生成测试并返回")
    public class TAC_STEP_01 extends NodeComponent {
    ...
    // 根据情况，进行并行处理
    @LiteflowComponent(value = "TAC_STEP_02", name="生成内容并发送到测试平台")
    public class TAC_STEP_02 extends NodeComponent {
