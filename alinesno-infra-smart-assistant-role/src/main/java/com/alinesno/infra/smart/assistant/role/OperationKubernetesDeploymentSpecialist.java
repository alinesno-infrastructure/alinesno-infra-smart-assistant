...
@Slf4j
@Component
public class OperationKubernetesDeploymentSpecialist extends PlatformExpert {

    private static final String promptId = "XPGeYb4a" ;
    private List<String> resultMap ;

    @LiteflowComponent(value = "OKDS_STEP_01", name="服务接口生成专家")
    public class OKDS_STEP_01 extends NodeComponent {
    ...
    // 根据情况，进行并行处理
    @LiteflowComponent(value = "OKDS_STEP_02", name="生成内容并发送到测试平台")
    public class OKDS_STEP_02 extends NodeComponent {
