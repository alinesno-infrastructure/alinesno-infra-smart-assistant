...
@Slf4j
@Component
public class TestApiSpecialist extends PlatformExpert {

    private static final String promptId = "JQxPeLRJ" ;
    private List<String> resultMap ;

    @LiteflowComponent(value = "TA_STEP_01", name="服务接口生成专家")
    public class TA_STEP_01 extends NodeComponent {
    ...
    // 根据情况，进行并行处理
    @LiteflowComponent(value = "TA_STEP_02", name="生成内容并发送到测试平台")
    public class TA_STEP_02 extends NodeComponent {
