...
@Slf4j
@Component
public class TeamTrainingContentSpecialist extends PlatformExpert {

    private static final String promptId = "KTHkQiDg" ;
    private List<String> resultMap ;

    @LiteflowComponent(value = "TTC_STEP_01", name="生成业务内容服务")
    ...
    // 根据情况，进行并行处理
    @LiteflowComponent(value = "TTC_STEP_02", name="生成内容并发送到内容平台")
