<template>
  <div class="app-container">
    <el-row :gutter="20">
      ...
      <el-col :span="24" :xs="24">
        ...
        <el-table v-loading="loading" :data="ApplicationList" @selection-change="handleSelectionChange">
          ...
          <el-table-column label="流程名称" align="left" width="250" key="workflowName" prop="workflowName" v-if="columns[1].visible" :show-overflow-tooltip="true">
            <template #default="scope">
          ...
          <el-table-column label="执行流程" align="left" key="stepWithTime" prop="stepWithTime" v-if="columns[3].visible" :show-overflow-tooltip="true"/>

          <el-table-column label="执行状态" align="center" key="workflowStatus" prop="workflowStatus" v-if="columns[3].visible" width="100" :show-overflow-tooltip="true">
            <template #default="scope">
          ...
          <el-table-column label="执行记录" align="center" key="id" prop="id" v-if="columns[5].visible" :show-overflow-tooltip="true" width="150">
            <template #default="scope">
          ...
          <el-table-column label="操作" align="center" width="150" class-name="small-padding fixed-width" v-if="columns[8].visible">
            <template #default="scope">
              ...
              <el-tooltip content="修改" placement="top" v-if="scope.row.applicationId !== 1">
                <el-button link type="primary" icon="Edit" @click="handleNodeRecord(scope.row)" v-hasPermi="['system:Application:edit']"></el-button>
              </el-tooltip>
    ...
    <!-- 添加或修改流程配置对话框 -->
    <el-dialog :title="title" v-model="open" width="1024px" append-to-body>
